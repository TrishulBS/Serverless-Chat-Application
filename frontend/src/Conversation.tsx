...
const Conversation = ({
   ...
   <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
      <div className="relative flex items-center space-x-4">
         ...
         <img src={`doggos/${targetNickname}.jpeg`} alt="" className="w-10 sm:w-16 h-10 sm:h-16 rounded-full ml-2"/>
         </div>
   ...
   <div id="messages" className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch h-screen">
      ...
      <div className="chat-message">
         <div className="flex items-end">
            ...
            <img src={`doggos/${group.sender}.jpeg`} alt="My profile" className="w-6 h-6 rounded-full order-1"/>
         </div>
      </div>
      ) : (
      <div className="chat-message">
         <div className="flex items-end justify-end">
            ...
            <img src={`doggos/${group.sender}.jpeg`} alt="My profile" className="w-6 h-6 rounded-full order-2"/>
         </div>
      </div>
      )
      )}
